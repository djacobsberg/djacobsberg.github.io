...
```
It is very interesting to see that parks are quite evenly distributed but tend to be in areas further away from the bay. Furthermore, there is a larger concentration arounf Stanford University's campus and in Charleston Meadows/Castry City. Next we will look at the income breakdown of Palo Alto.
<br>
<br>
...
```
The output is 0.7507 which means there are approximately 75.07% of people are within 10 minutes of a park. This is slightly higher than Oakland which was already incredibly high access. One possible reason may be that because the city is smaller, amentities are more concentrated and so are people, easily allowing a large number of people to be within 10 minutes of a park.

Next, let's see if there is a difference in income distribution in the population within a 10 min walk of a park compared to the entire population. Given Oakland's results, I also expect there to be a minimal difference here because of the similarity in these two groups.
