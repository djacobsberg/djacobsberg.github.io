...
The objective of this project is to combine multiple sources of data and a variety of techniques to quantify the potential damage associated with sea level rise over time. As I walk through the steps of this model, one of the main points I will emphasize are its assumptions, flaws and points to be considered.
...
Next, using 50years Census data, we estimated of the total number of owned vehicles which we will then apply the growth percentage to.
...
kable(final_table) %>% prettyNum(",") %>% paste0("$",.)
